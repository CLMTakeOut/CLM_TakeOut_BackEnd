...
<script>
import { listCollection, getCollection, delCollection, addCollection, updateCollection, exportCollection } from "@/api/system/collection";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除【请填写功能名称】编号为"' + collectionIds + '"的数据项?', "警告", {
