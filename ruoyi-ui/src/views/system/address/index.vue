<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="addressList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="地址id(主键)" align="center" prop="addressId" />
...
<script>
import { listAddress, getAddress, delAddress, addAddress, updateAddress, exportAddress } from "@/api/system/address";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除【请填写功能名称】编号为"' + addressIds + '"的数据项?', "警告", {
